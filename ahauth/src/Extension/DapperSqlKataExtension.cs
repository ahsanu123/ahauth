...
using Ahauth.Constant;
using Ahauth.Model;
using Dapper;
using SqlKata;
using SqlKata.Compilers;

namespace Ahauth.Extension;
...
public class DapperSqlKataExtensionHelper
{
    public static void LogRaw(SqlResult sqlResult)
    {
        ...
        UtilityExtension.ShowCurrentPosition(JsonSerializer.Serialize(sqlResult.NamedBindings));
    }
...
public static class DapperSqlKataExtension
{
    ...
    )
    {
        ...
        {
            var excludedType = MigrationListBase.listExcludedType.Any(exludedType =>
    ...
    )
    {
        ...
        if (printLog)
        {
            UtilityExtension.ShowCurrentPosition(JsonSerializer.Serialize(columnlists));
        }
